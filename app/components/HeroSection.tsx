...
export function HeroSection() {
  ...
  return (
    <div className="relative h-[50vh] sm:h-[70vh] mb-8 sm:mb-12 group overflow-hidden bg-black">
      {/* Background Content */}
      <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 flex items-center justify-end">
              <div className="relative w-full md:w-[65%] h-full">
                <div className="absolute inset-0">
                  ...
                  {/* Video edge gradients */}
                  <div className="absolute inset-0 bg-gradient-to-r from-black via-black/90 to-transparent w-1/2" />
        ...
        {/* Base gradients - Only show when video is not playing */}
        {!isVideoPlaying && (
          <>
            <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent" />
      ...
      <div className="absolute bottom-0 left-0 p-4 sm:p-8 md:px-20 md:py-16 max-w-3xl">
        ...
        <div className="flex flex-wrap items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
          ...
          <Link
            href={getDetailsLink(currentItem)}
            className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 
      ...
      {/* Navigation Dots */}
      <div className="absolute bottom-4 right-4 flex space-x-1.5 sm:space-x-2 z-10">
